  ...
  return (
    ...
    >
      <motion.button
        ...
        className={cn(
          "inline-flex h-4.5 w-4.5 shrink-0 items-center justify-center rounded-md border outline-none transition-colors duration-200",
          "focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
          "disabled:cursor-not-allowed disabled:opacity-60",
          showMark
            ? "border-primary bg-primary text-primary-foreground"
            : "border-muted-foreground/40 bg-background/60 hover:border-muted-foreground"
        )}
      >
      ...
      {label ? (
        <span className={cn("select-none text-xs text-foreground", disabled && "opacity-60")}>
          {label}
        </span>
      ) : null}
    </label>
