...
const ToastItem = memo(function ToastItem({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative overflow-hidden rounded-2xl border border-white/12 bg-zinc-950/98 p-3 shadow-2xl backdrop-blur-2xl",
          classNames?.surface,
        )}
      >
        {renderToast ? (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className={cn("min-w-0 flex-1", classNames?.content)}>
              ...
              {toast.action ? (
                <button
                  ...
                  className={cn(
                    "mt-2 inline-flex h-7 items-center rounded-full bg-primary/[0.08] px-3 text-xs font-medium text-foreground transition-colors hover:bg-primary/[0.15] cursor-pointer",
                    classNames?.action,
                  )}
                >
                  {toast.action.label}
            ...
            {canDismiss ? (
              <button
                ...
                className={cn(
                  "inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-white/[0.08] hover:text-foreground cursor-pointer",
                  classNames?.close,
                )}
              >
